...
public class JNumberKeys extends javax.swing.JPanel {
    ...
    public JNumberKeys() {
        ...
        javax.swing.ImageIcon originalIcon = new javax.swing.ImageIcon(
                getClass().getResource("/com/unicenta/images/btnequals.png"));
        javax.swing.ImageIcon pressedIcon = new javax.swing.ImageIcon(
                getClass().getResource("/com/unicenta/images/btnpressequals.png"));
        javax.swing.ImageIcon rolloverIcon = new javax.swing.ImageIcon(
                getClass().getResource("/com/unicenta/images/btnrolloverequals.png"));

        javax.swing.SwingUtilities.invokeLater(() -> {
            // Resize the image to fit the button size
            java.awt.Image resizedImage = originalIcon.getImage().getScaledInstance(
                    m_jEquals.getWidth(), // Width of the button
                    m_jEquals.getHeight(), // Height of the button
                    java.awt.Image.SCALE_SMOOTH // Scaling method
            );
            java.awt.Image resizedPressImage = pressedIcon.getImage().getScaledInstance(
                    m_jEquals.getWidth(), // Width of the button
                    m_jEquals.getHeight(), // Height of the button
                    java.awt.Image.SCALE_SMOOTH // Scaling method
            );
            java.awt.Image resizedRolloverImage = rolloverIcon.getImage().getScaledInstance(
                    m_jEquals.getWidth(), // Width of the button
                    m_jEquals.getHeight(), // Height of the button
                    java.awt.Image.SCALE_SMOOTH // Scaling method
            );

            m_jEquals.setIcon(new javax.swing.ImageIcon(resizedImage));
            m_jEquals.setPressedIcon(new javax.swing.ImageIcon(resizedPressImage));
            m_jEquals.setRolloverIcon(new javax.swing.ImageIcon(resizedRolloverImage));
        });
    ...
    private void initComponents() {
        ...
        m_jEquals.setBackground(new java.awt.Color(45, 140, 240));
        ...
        m_jEquals.setPreferredSize(new java.awt.Dimension(40, 80));
