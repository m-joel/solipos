 ...
 * It connects to and list SOLiPOS orders table rows and requires a
 * manual refresh using the button.
 * It runs independently of SOLiPOS and uses the provided orderpop.bat
...
public class OrderPop extends Application {
  ...
  public void start(Stage stage) throws InterruptedException, ExecutionException {
    ...
    stage.getIcons().add(new Image("/com/unicenta/images/solipos.png"));
 ...
 * as created by SOLiPOS or unicenta_remote_display apps
...
*/
  ...
  private Connection getConnection() throws ClassNotFoundException, SQLException {
    // use explicit connection rather than SOLiPOS instance session
